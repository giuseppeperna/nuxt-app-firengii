// Tutte le informazioni conservate in questo file, sono recuperabili da tutti i component grazie
// allo state manager Vuex. Una volta creato il file index.js all'interno della cartella store,
// Vuex viene attivato in automatico. In questo modo, non c'è bisogno di passare le informazioni
// tra components anche distanti fra loro attraverso i props.

// Piuttosto che importare nel componente tutte le informazioni presenti nello state manager, è più
// utile impostare dei getters che filtrano i dati e inviano ai componenti solo quelli che servono.
// I getters vanno registrate sempre in questo file, di norma dopo lo state.
...
// Lista di getters per il recupero dei dati nei singoli componenti. Tramite i getters è anche possibile
// aggiungere informazione alla collezione di dati.
export const getters = {
    // Recupera il prodotto in base all'ID. Si tratta di un metodo con il parametro state che rappresenta 
    // le informazioni salvate nello stato. A sua volta, il metodo include una funzione che ha come parametro
    // il payload inviato dal componente che richiede l'informazione. In questo caso, il payload rappresenta
    // l'id del prodotto che si intende ricercare.
    getProductById: (state) => (id) => {
        // ritorna il prodotto presente nello state di Vuex, all'interno dell'array products, che coincide
        // con l'id(il payload) inviato dal componente che ne ha fatto richiesta.
        return state.products.find(product => product.id == id);
    } 
}

// Lista dei mutations che permettono di cambiare lo stato delle informazioni salvate in Vuex.
export const mutations = {
    // Aggiunge un prodotto all'array myRentals
    addItem(state, id) {
        // Recupera il prodotto in base all'ID. Si tratta di un metodo con il parametro state che rappresenta 
        // le informazioni salvate nello stato. A sua volta, il metodo include una funzione che ha come parametro
        // il payload inviato dal componente che richiede l'informazione. In questo caso, il payload rappresenta
